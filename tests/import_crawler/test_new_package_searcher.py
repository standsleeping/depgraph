...
from depgraph.import_crawler.new_package_searcher import (
    get_ancestor_paths,
    new_find_module_in_package_hierarchy,
)
...
def test_find_module_direct_file(nested_package_structure):
    ...
    result = new_find_module_in_package_hierarchy("utils", deep_dir, root_dir)
...
def test_find_module_as_package(nested_package_structure):
    ...
    result = new_find_module_in_package_hierarchy("subpkg", deep_dir, root_dir)
...
def test_find_module_dotted_filename(nested_package_structure):
    ...
    result = new_find_module_in_package_hierarchy(
        "views.render", deep_dir, root_dir
    )
...
def test_find_module_in_middle_package(nested_package_structure):
    ...
    result = new_find_module_in_package_hierarchy("mid_utils", deep_dir, root_dir)
